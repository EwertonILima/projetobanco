...
public class BancoMenu{
	...
	public static void contaEspecial() {
		...
		do {
			...
			System.out.println("Você realizou todas as possíveis transações em Conta Especial, deseja continuar? (S/N)");
		...
		if (tipo[contaDigitada] == 1) {
				...
				if(opcao == 1) {
					...
					if (debito < saldo[contaDigitada]) {
						...
						System.out.println();
						System.out.println("O valor de debito é maior que a quantidade em saldo e o valor do Limite");
						System.out.println();
